...
//added by Allen 2016-08-29     104*32
unsigned char sBank[]={      
0x04,
0x00,0x68, 
   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
0x00,0x68, 
   ...
   ,
   ...
   0xff,0xff,0x03,0x0f,0x7f,0xff,0xff,0xfe,0xf8,0xe0,0x80,0x00,0x00,0x00,0x00,0x00,
   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x68, 
   0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,
   0x01,0x01,0x01,0x00,0x01,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
   0x00,0x00,0x00,0x01,0x01,0x01,0x01,0x00,0x00,0x00,0x01,0x01,0x01,0x01,0x00,0x00,
...
VOID InitPAX(void)
{
	...
	MagOpen(); //added by Allen 2016-08-29
	MagReset();//added by Allen for ZAIN 2016-08-29
}
...
int main(void)
{
  ...
  //  EMVCoreInit();         //removed by Allen 2016-08-25
    //AddAllVSDCtestKeys();
                // Gary: delete below
	...
	//ChangePinPadLogo("WELCOME!", 1, 3);     //removed by Allen 2016-08-25
	//ChangePinPadLogo("TAQSEET CARD", 2, 1);
    ...
    while (1) 
    {
        ...
        else if ( MagSwiped()==0 )
        {
			...
			ScrPrint(0, 5, ASCII, "Installments Card SRV");   //srv means services 
			ScrPrint(0, 6, ASCII, "        from");
			ScrPrint(0, 7, ASCII, "Prosper Bank");
...
//         return (2);
    ...
    //EMVSetPCIModeParam(1, (uchar *)"4,5,6,7,8", 120000);    removed by Allen 20151127
