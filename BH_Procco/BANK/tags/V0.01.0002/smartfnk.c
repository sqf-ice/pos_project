...
SC_STATUS PF_TxnFailed(void)         //added by Allen 2016-08-25    swipe card take the place of inert card , so TxnFailed take the place of remove card
{
    OS_ClearScreen();

    ScrPrint(0, 4, CFONT, DSP_TXN_FAILED);
	DelayMs(2000);
