...
//ACCONT MAINT-----------NET SERVER
	{ {0x60},{0x06,0x61},{0x00,0x00},{0x01,0x00},{0x00,0x00,0x00},{0x72,0x24,0x06,0x80,0x20,0x80,0x82,0x02} },// ACCOUNT MAINT
...
//BALANCE
	{ {0x60},{0x06,0x61},{0x00,0x00},{0x01,0x00},{0x30,0x00,0x00},{0x72,0x2C,0x06,0x80,0x20,0x82,0x80,0x02} },// BALANCE INQ // Modified by Kim_LinHB 2013-3-13 build 0.05.0009 add F47
//RETAIL
...
extern unsigned char ucDoNotHonorFlag;  // Added by Allen 2015-11-18 
...
//MK 02112007 Lost and Stolen Card
                if((ISOData.Field39[0]=='5')&&(ISOData.Field39[1]=='7') || (ISOData.Field39[0]=='0')&&(ISOData.Field39[1]=='5'))
                {
                    ucDoNotHonorFlag = 1;
                }
