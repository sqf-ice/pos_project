...
unsigned char FileCopy(BYTE *srcFile, BYTE *destFile);//add by Allen 20151117
...
WORD      PrintTransList	            (BYTE fbListing,BYTE Message, BYTE *Filename );     // modified by Allen 20151117
WORD	  BinCheck              (void);
WORD      InitFiles             (void);
