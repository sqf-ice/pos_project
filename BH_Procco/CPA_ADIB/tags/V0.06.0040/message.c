...
// Modified by Kim_LinHB 2014-3-7 improving error code handling
//by jarod 2011.06.01
int gHostErrMsgTableFlag[30] ={4,5,14,41,43,51,55,57,75,76,96,100,101,-1};

BYTE gHostErrMsgForDisp[30][120] =
{
 	"PICK UP",							//4
	"Do not Honour",					//5
	"No such Card",						//14
	"Pick up, lost card",				//41
	"Pick up, stolen card",				//43
	"Not sufficient funds",				//51
	"Incorrect PIN",					//55
	"   Transaction not       permitted to      cardholder ",	//57
	" Allowable number of PIN tries exceeded",					//75
	"      Wrong PIN          number of PIN    tries exceeded",	//76
	"System Malfunction",					//96
	"Communications Error",					//RC
	"Transaction could not be completed at this time. Please contact the call centre at the number on the back of your card."
};

const BYTE gHostErrMsgForPRT[30][120] =
{
	"        PICK UP         ",
	"     Do not Honour      ",
	"      No such card      ",
...
BYTE TYPE_75[]						 ="75";		//TENURE_CALCULATION
...
BYTE FILE_RT[LG_FILENAME+1]				 = "RTRT"; //name of all transaction tickets  file temp
...
BYTE PRT_TIMEOUT[]                       ="Time out.";
BYTE PRT_USERCANCELLED[]                 ="User Cancelled";
...
// Added by Kim_LinHB 2014-5-22
BYTE DSP_TIMEOUT[]						 =" Time out.";
BYTE DSP_USERCANCELLED[]				 =" User cancelled.";
...
BYTE DSP_BALANCELIST[]                 	 ="BALANCE INQUIRY";//"BALANCE LIST "
...
BYTE DSP_AMOUNT_MAX_LIMIT[]				   ="AMOUNT>MAX.LIMIT";
