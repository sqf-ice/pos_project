...
//added by Allen 
/*MENU*/const BYTE *gConnectMenu[] =
{
    "CONNECT",
    "GPRS",
    "DIAL-UP"
};
/*MENU*/const BYTE *gReversalMenu[] =
{
    "VOID/REVERSAL",
    "REWARD REVERSAL",
    "REDEEM REVERSAL"
...
//by jarod 2011.06.01
//const int gHostErrMsgTableFlag[20] ={0,5,41,43,51,55,57,75,76,96};
//modified by Allen 2016-09-20 
const int gHostErrMsgTableFlag[20] ={0,1,5,9,41,43,51,55,57,75,76,96};

const BYTE gHostErrMsgForDisp[15][100] =
{
	"Do not Honor",
	"Wrong Amount",    //added by Allen 2016-09-20
	"Insufficient Balance",
	"Wrong RRN",         //added by Allen 2016-09-20
	"Pick up, lost card",
	"Pick up, stolen card",
...
BYTE TYPE_75[]						 ="75";
BYTE TYPE_76[]                              = "76"; // added by Allen for ZAIN 2016-05-03  (void/reversal)
...
BYTE FILE_DIAL_UP_PAR[LG_FILENAME+1] = "DIAL"; // added by Allen 2016-05-19

BYTE FILE_CONNECT_MODE[LG_FILENAME+1] = "CONT"; // added by Allen 2016-05-19

BYTE FILE_END_OF_DAY[LG_FILENAME+1] = "FEND";   //added by Allen 2016-05-23
BYTE FILE_REF[LG_FILENAME + 1]			= "REF";  //add by jeff_xiehuan20161216
...
BYTE PRT_LOSMARTDEBIT[] 			     ="DEBIT ";
BYTE PRT_LOSMARTLOYALTY[] 			     ="LYLT";
BYTE PRT_LOSMARTPAYMENT[] 			     ="CREDIT";
//BYTE PRT_LOSMARTACCOUNT_MAINT[] 		 ="AMNT";

//added by Allen 2016-05-25
BYTE PRT_LOSMARTREWARD[] 			     ="Reward ";
BYTE PRT_LOSMARTREDEEM[] 			     ="Redeem ";
BYTE PRT_LOSMARTREVERSAL[]             ="Reversal ";  //added by Allen 2016-09-20
//add end
...
//BYTE PRT_SALE_UNIT[] 		             ="WITHDRAW/DEBIT      :";
BYTE PRT_LOYALTY_UNIT[] 		         ="LOYALTY UNIT        :";
//BYTE PRT_PAYMENT_UNIT[] 		         ="DEPOSIT/CREDIT      :";

//modified by Allen 2016-05-25
BYTE PRT_SALE_UNIT[] 		             ="Rewarding           :";
BYTE PRT_PAYMENT_UNIT[] 		         ="Redemption          :";
BYTE PRT_REVERSALNUIT[]                ="Reversal            :";     //added by Allen 2016-09-20
//modify end
...
BYTE PRT_REJECTED[]                      ="Card PIN Blocked"; //"Card is blocked";   
/////////////////////////////////////////////////////////////////////////////
//DISPLAY MESSAGES///////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////
...
BYTE DSP_REJECTED[] 		           	 =" Card pin blocked please contact  the call centre";
...
BYTE DSP_TXN_FAILED[]                         ="TXN FAILED ";   //added by Allen 2016-08-25
...
//BYTE DSP_CHECK_BALANCE[]				 ="CHECK BALANCE";//add by lqc 20150619

BYTE DSP_LASTTRANS[]                   	 ="LAST 10 TRANS";

//BYTE DSP_INSTALLMENT[]                 	 ="RETAIL TRANSACTION/*INSTALMENT  */ ";
BYTE DSP_WITHDRAW_DEBIT[]				 ="WITHDRAW / DEBIT";//add by lqc 20150619

BYTE DSP_LOYALTY[]                     	 ="LOYALTY      ";

//BYTE DSP_PAYMENT[]                     	 ="PAYMENT      ";
BYTE DSP_DEPOSIT_CREDIT[]                ="DEPOSIT / CREDIT      ";//add by lqc 20150619

BYTE DSP_ACCOUNT_MAINT[]               	 ="ACCOUNT MAINT";
BYTE DSP_PRODUCT_TYPE[] 		       	 ="PRODUCT TYPE    ";

//BYTE DSP_TENURE_CALC[]					 ="TENURE CALCULATION";
BYTE DSP_END_OF_SHIFT[]					 ="END OF SHIFT";//add by lqc 20150619

//added by Allen for ZAIN 2016-05-03
BYTE DSP_POINTS_REWARD_SALE[]					 ="Points Reward/Sale";
BYTE DSP_REDEEM[]					 ="Redeem";
BYTE DSP_CHECK_BALANCE[]					 ="Check Balance";
BYTE DSP_VOID_REVERSAL[]					 ="Void/Reversal";
//add end
