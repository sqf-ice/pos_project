...
unsigned char bBalanceFromOptions = FALSE;	// Added by Kim_LinHB 2013-3-8 build 0.05.0009
...
BYTE gConnectMode;   // added by Allen for ZAIN 2016-05-19
BYTE gReversalType;  // added by Allen for ZAIN 2016-07-30
EODPARAM gEODParam;      // added by Allen for ZAIN 2016-05-23
...
//BYTE gAmountReversal[LG_AMOUNT+1];    //added by Allen 2016-09-22
...
void M_MerchantMenu(void)
{
    ...
    HDGStruct lsHDGBuf;
	unsigned char szDateTime[7];  //added by Allen 2016-05-23


    ReadStateFile();

// removed by richard 20150630
...
//    }
    ...
    while(lwStatus!=STAT_OK)
    {
        ...
        switch(lbRet)
        {
        case SECOND_COPY:                      //modified by Allen 20151116
        ...
        case BATCH_CLOSE:
			...
			{
				gEODParam.EODFlag = 0;  //0 - no need 
				GetTime(gEODParam.szDateTime);
				SaveEODFlag();
			}
			//end
            break;
