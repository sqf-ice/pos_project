...
int CheckRefNumber(unsigned char* pRRN);       //added by Allen 2016-05-30
...
WORD      DebugMenu                    (void);
WORD      ConnectMode(void) ;           //added by Allen for ZAIN 2016-05-19
WORD      ReversalMode(void);           //added by Allen for ZAIN 2016-07-05
WORD	  DebugType					   (void);
...
WORD SetupDial_upParam(void);  //added by Allen 2016-05-19
//Comminication Funct.
...
SC_STATUS PF_TxnFailed(void);       //added by Allen 2016-08-25 
...
WORD      TransMenu               (BYTE fbBalance,BYTE fbVoidReversal,BYTE fbInstallment,BYTE fbLoyalty,BYTE fbPayment,BYTE fbAccountMaintenance);
...
WORD     ConnectInit(void);   //added by Allen 2016-05-19
WORD     EndOfDayFlagInit(void);//added by Allen 2016-05-23
