...
WORD Enter_Item_Price(BYTE *psPriceBcd)
{
    ...
    strcpy(MainMSG.CSTMSG1, "Withdraw Amount:");//modify by lqc 20150618
...
//#endif
        ...
        else if ( (key=IccDetect(0))!=0xFF )
        {
            ...
            ScrGotoxy(4, 0);
            //ScrDrLogo(sAlBarakaLogo_Display);//need to modify
			ScrDrLogo(sSelektpayNECLogo_Display);
			//modify by lqc 20150617
			ScrPrint(0, 4, ASCII, "Welcome To Selectpay-NEC Services");
...
void Main_IdleScreen(void)
{
    ...
    ScrPrint(0, 2, CFONT, "  Selektpay-NEC  ");
