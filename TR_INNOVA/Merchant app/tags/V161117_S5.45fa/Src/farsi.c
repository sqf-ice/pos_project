...
// #define	O_RDWR     PAX_O_RDWR		   //O_RDWR     v1.0
// #define	O_CREATE   PAX_O_CREATE	       //O_CREATE
// #define	O_ENCRYPT  PAX_O_ENCRYPT      //O_ENCRYPT 
// 
// #define SEEK_CUR PAX_SEEK_CUR	      //SEEK_CUR
// #define	SEEK_SET PAX_SEEK_SET			//SEEK_SET
// #define	SEEK_END PAX_SEEK_END			//SEEK_END
...
int IfArabicString(const unsigned char *str) //v4.16
{
	while(1)
	{
		if (*str >= 0x80)
