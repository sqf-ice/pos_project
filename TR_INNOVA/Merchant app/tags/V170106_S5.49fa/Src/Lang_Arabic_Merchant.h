...
****************************************************************************/
#ifndef _LANG_ARABIC_H 
#define _LANG_ARABIC_H

#ifdef FARSI
#include "appLib.h"

MENU_ITEM PrintMenu_Arabic[]=
{
	{ "„Œ“Ê‰ ⁄«„", ID_PrintGeneral,		NULL },
	{ "„Œ“Ê‰  ›’Ì·Ì", ID_PrintDetail,	NULL },
	{ "",			 0,					NULL },
};

MENU_ITEM StockMenu_Arabic[]= 
{
	{ "√ÿ»⁄ «·„Œ“Ê‰", ID_PrintStock,	NULL },
	{ "√⁄—÷ «·„Œ“Ê‰", ID_DispStock,NULL },
	{ "",			 0,				NULL },
};

MENU_ITEM ReportsMenu_Arabic[] = 
{
	{ " ’—«›", ID_ReportCashier,	NULL },
	{ "„œÌ—", ID_ReportManager,	NULL },
	//{ "Server", ID_ReportServer,	NULL },
	{ "",				  0,		NULL },
};

MENU_ITEM TransmissionMenu_Arabic[]=
{
	{ " Õ„Ì· «·≈⁄œ«\xcf",	ID_SettingsDownload,NULL},    
	{ "«” ⁄·«„ «·„»Ì⁄« ",		ID_SalesPolling,	NULL},
	{ "≈·€«¡ ⁄„·Ì… »Ì⁄",		ID_CancelSale,		NULL},
	{ "„ÿ«·»…",				ID_Claim,			NULL},
	{ " Õ’Ì· «·»—Ìœ",	ID_GetMail,			NULL}, // Modified by Kim_LinHB 2014/11/4
	{ " Õ„Ì· »—‰«„Ã",		ID_SoftDownload,	NULL},
	{ " ÕÌ· «·‘⁄«—",		ID_LogoDownload,	NULL},
	{ "«·—’Ìœ",			ID_Balance,			NULL}, // Modified by Kim_LinHB 2014/11/4
	//  { "Set Auto        ", ID_Config_Auto,		NULL },
	//  { "First Init. Auto", ID_First_Init__Auto,	NULL },
	{ "",				  0,					NULL },
};

MENU_ITEM CashierMenu_Arabic[]=
{
...
MENU_ITEM RestockMenu_Arabic[]=
{
	{ "   ≈⁄«œ…  Œ“Ì‰ —„Ê“   ",		ID_RestockPin,		NULL},
	{ " ÿ·» „⁄·ﬁ  ",		ID_PendingOrder,		NULL}, 
	{ "",				  0,			NULL },
};

MENU_ITEM MainMenu_Arabic[]= 
{
	{ "—„Ê“ «·»Ì\xda", ID_SaleCodes, NULL },
	{ "„“œÊ\xcc", ID_Duplicate,			NULL },
	{ "ÿ·» ‰ﬁœÌ", ID_CashOrder,			NULL },
	{ "≈⁄«œ…  Œ“Ì‰ —„Ê“ «· ⁄—Ì\xdd", ID_RestockPins,		NULL },
	{ "„Œ“Ê\xe4", ID_Stocks,			NULL },
	{ "Œœ„… «· ‘€Ì·/≈Ìﬁ«› «· ‘€Ì\xe1", ID_ON_OFFService,		NULL },
	{ " ﬁ«—Ì—", ID_Reports,			NULL },
	{ "≈⁄œ«œ«  «·„œÌ—", ID_ManagerSettings,	NULL },
...
unsigned char STR_GPRS_FA[] = "Ã«—Ì «·≈ ’«·"; // Modified by Kim_LinHB 2014/11/4
...
unsigned char STR_PASSWORD_MANAGER_FA[] = "ﬂ·„… ”— «·„œÌ—";
...
unsigned char STR_MENU_CONNECTION_FA[] = "ﬁ«∆„?«·« ’«·«?b";
...
unsigned char STR_NAME_FA[] = "«”„";
unsigned char STR_SOLDE_FA[] = "«·—’Ìœ";
...
unsigned char STR_ERROR_MSG_FA[] = "Message:";	// Modified by Kim_LinHB 2013-12-17 v4.78 removed "Error "
unsigned char STR_PINS_RESTOCKED_FA[] = "Pins Restocked:";
//Added by Allen 2016/03/16
unsigned char STR_VOUCHER_NUMBER_FA[] = "Voucher number:";
unsigned char STR_RECHARGE_NNUMBER_FA[] = "Recharge Number:";
//Add End
// Added by Kim_LinHB 2014/11/4
unsigned char STR_CASHIER_LOGIN_FA[] = "œŒÊ· «·ﬂ«‘Ì—";
unsigned char STR_TRANS_MODE_FA[] = "‰Ê⁄ «·⁄„·Ì…";
unsigned char STR_TRANS_OFFLINE_FA[] = "«Ê› ·«Ì‰";
unsigned char STR_TRANS_ONLINE_FA[] = "«Ê‰ ·«Ì‰";
unsigned char STR_SENDING_FA[] = "≈—”«·";
unsigned char STR_RECEIVING_FA[] = " ”·„";
// Add End
...
unsigned char *gl_pStr_Arabic[] = 
{
	...
	// Added by Kim_LinHB 2014/11/4
	STR_CASHIER_LOGIN_FA,
	STR_TRANS_MODE_FA,
	STR_TRANS_OFFLINE_FA,
	STR_TRANS_ONLINE_FA,
	STR_SENDING_FA,
	STR_RECEIVING_FA,
	// Add End
	//Added by Allen 2016/03/16
    STR_VOUCHER_NUMBER_FA,
    STR_RECHARGE_NNUMBER_FA,
//Add End
};
#endif
